...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{asset('back-end/admin')}}/images/favicon.ico" type="image/x-icon">
    <!-- fontawesome icon -->
    <link rel="stylesheet" href="{{asset('back-end/admin')}}/fonts/fontawesome/css/fontawesome-all.min.css">
    <!-- animation css -->
    <link rel="stylesheet" href="{{asset('back-end/admin')}}/plugins/animation/css/animate.min.css">
    <!-- vendor css -->
    <link rel="stylesheet" href="{{asset('back-end/admin')}}/css/style.css">
...
<body>
        ...
        <div class="navbar-wrapper">
            <div class="navbar-brand header-logo">
                <a href="index.html" class="b-brand">
                    ...
                    <span class="b-title">Nguyen Phuc Blog</span>
                </a>
                ...
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                      ...
                      <ul class="pcoded-submenu">
                        ...
                        <li class=""><a href="bc_button.html" class="">List post</a></li>
                    ...
                    {{-- COMMENT  --}}
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                      <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Comments</span></a>
                      <ul class="pcoded-submenu">
                    ...
                    {{-- SETTING  --}}
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                      <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Settings</span></a>
                      <ul class="pcoded-submenu">
                          <li class=""><a href="bc_button.html" class="">Settings</a></li>                         
                      </ul>
                  </li>
    ...
    <!-- Required Js -->
<script src="{{asset('back-end/admin')}}/js/vendor-all.min.js"></script>
	<script src="{{asset('back-end/admin')}}/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="{{asset('back-end/admin')}}/js/pcoded.min.js"></script>
